...
export default function RecentLeaveTable({requestCancel}) {
    ...
    function createData(leaveDate, leaveType, leaveCnt, appDate, approver, status) {
        return { leaveDate, leaveType, leaveCnt, appDate, approver, status };
    }

    const datas = [
        createData('2023/10/11', '연차', '1', '2023/10/07', '이유나 팀장', 0),
        createData('2023/10/11', '반차', '0.5', '2023/10/07', '이유나 팀장', 0),
        createData('2023/10/11', '연차', '1', '2023/10/07', '이유나 팀장', 1),
                        ...
                        {stableSort(datas, getComparator(order, orderBy)).map((data, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <TableCell align="center">
                                        <Button variant="contained" size="small" onClick={requestCancel}>
                                                취소신청
                                        </Button>
                                    </TableCell>
                                </TableRow>
