...
import { Box, Button, Card, CardContent, Chip, FormControl, FormControlLabel, Radio, RadioGroup, Tab, Tabs, TextField } from '../../node_modules/@mui/material/index';
...
const ApprovalAttendance = () => {
    ...
    const handleChange1 = (event, newValue) => { // 전체 Tab
        setValue1(newValue);
        setValue2(0);
        setSelectData({});
    };

    const handleChange2 = (event, newValue) => { // 휴가 부분 Tab
        setValue2(newValue);
        setSelectData({});
    };
    ...
    let waitapp = 0;
    datas.map((data) => {
        if (data.status == 0) { app++; }
        else if (data.status == 1) { unapp++; }
        else if (data.status == 2) { waitapp++; }
    })
                    ...
                    <BasicContainer>
                        <Grid container spacing={2}>
                            <Grid item xs={2.5} sm={2.5} md={2.5} lg={2.5} >
                                <MyCardAll onClick={() => { setValue2(2); setSelectData({}) }}>
                            ...
                            <Grid item xs={2.5} sm={2.5} md={2.5} lg={2.5} >
                                <MyCardM onClick={() => { setValue2(0); setSelectData({}) }}>
                                    <CardContent sx={{ textAlign: "center" }}>
                            ...
                            <Grid item xs={7} sm={7} md={7} lg={7}>
                                <MyCardL onClick={() => { setValue2(1); setSelectData({}) }}>
                                    <CardContent sx={{ textAlign: "center" }}>
                                        <Grid container spacing={2}>
